...
metrics[HCR == 'SS', mp := 1]
metrics[HCR == 'ConstantF_min', mp := 2]
metrics[HCR == 'ConstantF_max', mp := 3]
metrics[HCR == 'PSPS_min', mp := 4]
metrics[HCR == 'PSPS_max', mp := 5]

metrics[, metric2 := metric]
metrics[metric2 == 'B/Bmsy-Cod',        metric := 'a']
metrics[metric2 == 'B/Bmsy-Haddock',    metric := 'b']
metrics[metric2 == 'B/Bmsy-AtlHerring', metric := 'c']
metrics[metric2 == 'F/Fmsy-Cod',        metric := 'd']
metrics[metric2 == 'F/Fmsy-Haddock',    metric := 'e']
metrics[metric2 == 'F/Fmsy-AtlHerring', metric := 'f']
metrics[metric2 == 'IAV',               metric := 'g']
metrics[metric2 == 'Total Yield',       metric := 'h']
